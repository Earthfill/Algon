...
const Checker = () => {
  return (
    <div className="bg-[url('/updatedcar.jpg')] bg-cover bg-no-repeat bg-center">
      <div className="bg-royal-red bg-opacity-90 text-center text-white xl:pb-8 pb-24">
        <div className="xl:text-5xl xl:pt-6 px-16 pt-14 pb-3 font-bold text-3xl">Check Registration Status</div>
        <div className="xl:text-lg px-10 xl:pb-3 pb-7 font-semibold text-[13px]">Enter the Vehicle Registration Number to see the registration status</div>
