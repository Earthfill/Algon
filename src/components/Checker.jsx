  ...
  return (
    <div className="bg-[url('/updatedcar.jpg')] bg-cover bg-no-repeat bg-center">
      <div className="bg-royal-red bg-opacity-90 text-center text-white xl:pb-14 pb-24">
        ...
        <div className="xl:text-lg px-10 pb-7 font-semibold text-[13px]">Enter Car Registration Number to see registration status</div>
        <div className="xl:w-[600px] xl:mx-auto rounded-md mt-20 mx-14 bg-pale-red">
          <form action="" className="xl:p-10 p-6 flex flex-col gap-6">
            <input placeholder="ENTER REGISTRATION NUMBER" className="xl:outline-none xl:pl-2 rounded-md py-2 text-black placeholder:text-slate-500 placeholder:text-sm placeholder:font-bolder placeholder:text-center" />
